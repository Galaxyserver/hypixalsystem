...
if (message.content.startsWith(prefix + 'help')) {
	...
	`=-=-=-=-=-= 🌍 Public Commands - اوامر عامة 🌍 =-=-=-=-=-=
     ✴ Hsug =====> To Suggest | لعمل اقتراح
    ✴ Hid ======> To Show Your ID | ايدي حسابك
    ✴ Hping ====> Ping Of Bot | بنج حك البوت
    ✴ Hallbots => Show All Bots In The Server | لاضهار جميع البوتات
    ✴ Hbot =====> Information Of The Bot | معلومات البوت
    ✴ Hserver ==> Information Of The Server | معلومات السيرفر
    ✴ Hcount ===> Member Count | عدد الاشخاص في السيرفر
    ✴ Hcal =====> To Calculate | اله لحاسبة 
    ✴ Htag =====> To Tag A Word | لعمل تاق لكلمة 
    ✴ Hrooms ===> Show Rooms Of Server | اضهار الرومات الي في السيرفر
    ✴ Hza5 =====> To decorate Some Word | لزخرفة الكلمات
    ✴ Hroles ===> Show Roles Of The Server | اضهار الرانكات
    ✴ Hemojis ==> Emoji Of Server | ايموجيات السيرفر   
    ✴ Hsay =====> The Bot Say Any Thing | تكرار اي شي كتبتو
    ✴ Himage ===> To Show Image Of Server | لاضهار صورة السيرف 
    ✴ Hcontact => To Contact Owners Bot | مراسلة صاحب البوت
    ✴ Hinvite \ -inv => Invite Bot | لدعوة البوت
    ✴ Hembed ===> To Embed | لتكرار اي شي كتبتو بطريقة حلوة
    ✴ Havatar ==> Your Avatar | صورتك الشخصية
    ✴ Hsupport => Server Support | سيرفر الدعم الفني
     ===========================================================
      React With ▶ To See Admins Commands`,
	`=-=-=-=-=-= 🔧  Admin Commands - اوامر ادارية 🔧 =-=-=-=-=-=
    ❖ Hmove @user => Move User To Your Room Voice | لسحب الشخص الى روومك
    ❖ Hmvall => Move All To Your Room Voice | لسحب الجميع الي روومك
    ❖ Hbc => Broadcast | رسالة جماعية الى كل اعضاء السيرفر
    ❖ Hrole @user <rank> => Give User Rank | لأعطاء رتبة لعضو معين
    ❖ Hroleremove @user <rank> => remove Rank From User | لازالة الرتبة من شخص معين
    ❖ Hrole all <rank> => Give All Rank | لأعطاء رتبة للجميع
    ❖ Hrole humans <rank> => Give Humans Rank | لأعطاء رتبة للاشخاص فقط
    ❖ Hrole bots <rank> => Give Bots Rank | لأعطاء رتبة لجميع البوتات
    ❖ Hhchannel => Hide Channel | اخفاء الشات
    ❖ Hschannel => Show The Hidden Channel | اضهار الشات المخفية
    ❖ Hclr <numbr> => Clear Chat With Number | مسح الشات بعدد
    ❖ Hclear => Clear Chat | مسح الشات
    ❖ Hmute @user <reason> => Mute User | اعطاء العضو ميوت لازم رتبة <Muted>
    ❖ Hunmute @user => Unmute User | لفك الميوت عن الشخص 
    ❖ Hkick @user <reason> => Kick User From Server | طرد الشخص من السيرفر
    ❖ Hban @user <reason> => Ban User From Server | حضر الشخص من السيرفر
    ❖ Hmutechannel => Mute Channel | تقفيل الشات
    ❖ Hunmutechannel => Unmute Channel | فتح الشات
    ❖ Hdc => Delete All Rooms |  مسح كل الرومات
    ❖ Hdr => Delete All Rank <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات
    ❖ Hccolors <number> => Create Colors | ينشا لك الوان مع كم الوان تبي
    ❖ Hkv @user => Voice Kick | يطرد شخص من الرووم
    ❖ Hvonline => Create Channel Voice Online | يسوي رووم فويس اونلاين
     ===========================================================
    ...
    💠 Hxo @user => Game XO | لعب اكس او
    💠 Hrps => Rock & Paper & Scissors | لعبة حجر ورقة مقص
    💠 Hslots => Game Of Fruits | لعبة الفواكه
    💠 Hmarry @user => لعبة الزواج
    💠 Hspeed => لعبة سرعة كتابة 
    💠 Hلعبة فكك <= فكك
    💠 Hلعبة عواصم <= عواصم
    💠 Hالبوت يعطيك نصائح <= هل تعلم
    ...
    ❖ Hplay => لتشغيل أغنية برآبط أو بأسم
    ❖ Hskip => لتجآوز الأغنية الحآلية
    ❖ Hpause => إيقآف الأغنية مؤقتا
    ❖ Hresume => لموآصلة الإغنية بعد إيقآفهآ مؤقتا
    ❖ Hvol => لتغيير درجة الصوت 100 - 0
    ❖ Hstop => لإخرآج البوت من الروم
    ❖ Hnp => لمعرفة الأغنية المشغلة حآليا
    ❖ Hqueue => لمعرفة قآئمة التشغيل
...
if (!points[message.author.id]) points[message.author.id] = {
  ...
  if(!message.guild) return;
    let id = message.author.id,prefix="H";
